...
# Column display configuration - INCLUDING volume ratio
BASE_COLUMNS = ['Symbol', 'Price', '24h Return %', '24h Volume Change %', '24h Vol/30d Avg']
...
COLORS = {
    ...
    'text': '#e0e0e0',
    'text_muted': '#888',
    'header_text': '#FFFFFF',   # Bright white for headers
    'bitcoin_orange': '#f7931a' # Bitcoin orange
}